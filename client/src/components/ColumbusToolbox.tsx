...
import { Copy, Check, Lightbulb, Building2, Landmark, TrendingUp } from "lucide-react";
...
const lainieTips: Record<string, string> = {
  "The Tech Surge": "The Short North is evolving faster than any neighborhood in the Midwest. Lead with data—the 200% surge is real and resonates with tech founders who think in metrics. Position yourself as someone tracking the wave, not chasing it.",
  "Institutional Authority": "German Village businesses value heritage and discretion. Don't pitch speed—pitch precision. They want to know you understand the weight of their brand and the history of their brick-and-mortar presence.",
  "The Blueprint Strategy": "Downtown developers think in phases and timelines. Show them you understand their cycle. The 'Blueprint' metaphor works because it speaks their language—architecture, planning, execution."
};
      ...
      <div className="relative overflow-hidden rounded-3xl border border-lnl-violet/20 bg-gradient-to-br from-[#1a1625] via-background to-[#1a1a2e]">
        ...
        <div className="relative z-10 p-8 md:p-10">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-xs font-mono uppercase tracking-widest text-lnl-violet/80">Midwest Momentum</span>
          </div>
          
          <h3 className="text-2xl md:text-3xl font-display font-medium text-white mb-2">
            Columbus Community Outreach Toolbox
          </h3>
          <p className="text-muted-foreground mb-8 max-w-2xl">
            Strategic scripts for Columbus's high-growth districts. From the Short North's tech surge to German Village's institutional prestige.
          </p>
